    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if ($('[name="leaveblank"]').val().length != 0) {
                ...
                $('#form-erro').html("<div class='uk-alert-danger uk-text-center' uk-alert> Desculpe, mas não foi possível enviar a mensagem, entre em contato pelo telefone: (11) 2222-2897 </div>")
                    .hide()
